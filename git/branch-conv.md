...
7. При обнаружении новых багов после релиза, нужно откатить его и вернуть приложение в первоначальное состояние. При условии, что их невозможно исправить за час.
- Примеры:
```
release/1.01.123
```
