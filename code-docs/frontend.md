...
JSDoc позволяют автоматически генерировать документацию на основе комментариев в коде. Это полезно для создания HTML или PDF-документации без дополнительного труда.
...
## D. Инструменты
- [JSDoc](https://www.typescriptlang.org/docs/handbook/jsdoc-supported-types.html) - документирование кода. Интегрируется с Mermaid, PlantUml для создания диаграмм, а так же с для создания сайта с документацией кода.
